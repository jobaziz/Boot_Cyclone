...
error_t flashDriverSwapBanksNoInit(void)
{
   ...
   do
   {
      ...
      do
      {
         ...
         {
            MODIFY_REG(FLASH->OPTR, FLASH_OPTR_SWAP_BANK, FLASH_OPTR_SWAP_BANK & OB_SWAP_BANK_DISABLE);
         }
         else
         {
            MODIFY_REG(FLASH->OPTR, FLASH_OPTR_SWAP_BANK, FLASH_OPTR_SWAP_BANK & OB_SWAP_BANK_ENABLE);
         }
