...
:: Load initial firmware binary in MCU flash bank 1 at 0x00000000
JLink.exe -device ATSAME54P20 -if SWD -speed 4000 -autoconnect 1 -CommanderScript ./jlink/load_initial_firmware.jlink
