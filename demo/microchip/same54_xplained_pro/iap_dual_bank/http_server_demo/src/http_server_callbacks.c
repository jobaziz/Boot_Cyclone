   ...
   else if(!strcasecmp(uri, "/upload/binary"))
   {
      ...
      do
      {
         ...
         do
         {
            ...
            updateSettings.memories[0].driver               = &sam_ed_5x_FlashDriver;
            ...
            updateSettings.memories[0].slots[0].addr        = 0x00000000;
            updateSettings.memories[0].slots[0].size        = 0x80000;
            ...
            updateSettings.memories[0].slots[1].addr        = 0x00080000;
            updateSettings.memories[0].slots[1].size        = 0x80000;
