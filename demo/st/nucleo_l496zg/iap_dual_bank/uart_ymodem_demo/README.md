...
**Manual Method** 
1. Connect the evaluation board to your computer
2. Run the following command in the Windows console: `STM32_Programmer_CLI.exe -c port=SWD index=0 -ob nSWBOOT0=0 nBOOT0=1 BFB2=0`
...
This UART/Y-Modem demo uses two separate UART interfaces: 
